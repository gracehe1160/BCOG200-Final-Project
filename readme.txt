...
1) I would like to create a chatbot, following one of the example suggestions on the final project page. This chatbot will respond and have conversations with the user input. I will use the Natural Language Toolkit and the ChatterBot library to create this program.
2) 
